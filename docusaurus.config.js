...
const config = {
  ...
  organizationName: 'zwwang98', // Usually your GitHub org/user name.
  ...
  presets: [
    [
      ...
      ({
        ...
        blog: {
          blogTitle: 'Blogs by Ziwei Wang',
          blogDescription: 'Blogs by Ziwei Wang',
          postsPerPage: 'ALL',
  ...
  themeConfig:
    ...
    ({
      ...
      footer: {
        ...
        copyright: `Copyright © ${new Date().getFullYear()} Ziwei Wang. Built with Docusaurus.`,
      },
      prism: {
